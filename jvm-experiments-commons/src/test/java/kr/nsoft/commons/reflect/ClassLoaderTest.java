    ...
    public void differentClassLoader() throws Exception {
        ClassLoader testClassLoader = new ClassLoader() {
            ...
            protected synchronized Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
                ...
                if (!name.equals("kr.nsoft.commons.reflect.ClassLoaderTest$TestClass"))
        ...
        Class testClass = testClassLoader.loadClass("kr.nsoft.commons.reflect.ClassLoaderTest$TestClass");
