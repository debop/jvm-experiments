...
public class TimePeriodCollection extends TimePeriodContainer implements ITimePeriodCollection {
    ...
    public boolean hasInsidePeriods(final ITimePeriod target) {
        ...
        if (TimePeriodCollection.log.isDebugEnabled())
            TimePeriodCollection.log.debug("target [{}]에 속하는 ITimePeriod 요소가 있는가? [{}]", target, result);
    ...
    public boolean hasOverlapPeriods(final ITimePeriod target) {
        ...
        if (TimePeriodCollection.log.isDebugEnabled())
            TimePeriodCollection.log.debug("target [{}]과 overlap 되는 ITimePeriod 요소가 있는가? [{}]", target, result);
    ...
    public boolean hasIntersectionPeriods(final DateTime moment) {
        ...
        if (TimePeriodCollection.log.isDebugEnabled())
            TimePeriodCollection.log.debug("moment[{}]과 기간이 교차하는 ITimePeriod 요소가 있는가? [{}]", moment, result);
    ...
    public boolean hasIntersectionPeriods(final ITimePeriod target) {
        ...
        if (TimePeriodCollection.log.isDebugEnabled())
            TimePeriodCollection.log.debug("target [{}]과 교집합(intersection)되는 ITimePeriod 요소가 있는가? [{}]", target, result);
