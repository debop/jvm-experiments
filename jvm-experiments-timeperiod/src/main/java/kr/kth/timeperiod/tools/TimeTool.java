...
public class TimeTool {
    ...
    private static final boolean isDebugEnabled = TimeTool.log.isDebugEnabled();
    ...
    /**
     * 지정한 {@link kr.kth.timeperiod.ITimeCalendar} 기준으로 moment가 속한 년도를 구합니다.
     */
    ...
    public static DateTime startTimeOfYear(DateTime moment, int startMonthOfYear) {
        ...
        if (TimeTool.log.isDebugEnabled())
            TimeTool.log.debug("DateTime [{}]이 속한 Year의 시작일은 [{}] 입니다. startMonthOfYear=[{}]",
...
//		return result;
    ...
    public static List<? extends ITimePeriod> forEachYears(ITimePeriod period) {
        ...
        if (isDebugEnabled)
            TimeTool.log.debug("기간 [{}]에 대해 Year 단위로 열거합니다", period);
    ...
    public static boolean hasInside(ITimePeriod period, DateTime target) {
        ...
        if (isDebugEnabled)
            TimeTool.log.debug("기간[{}]에 대상날짜[{}]가 포함(Inside)되는지 여부를 검사. hasInside=[{}]",
    ...
    public static PeriodRelation getRelation(ITimePeriod period, ITimePeriod target) {
        ...
        if (isDebugEnabled)
            TimeTool.log.debug("period[{}], target[{}] 의 relation=[{}] 입니다.", asString(period), asString(target), relation);
    ...
    public static boolean intersectsWith(ITimePeriod period, ITimePeriod target) {
        ...
        if (isDebugEnabled)
            TimeTool.log.debug("period=[{}], target=[{}]에 교차구간이 있는지 확인합니다. isIntersected=[{}]",
    ...
    public static boolean overlapsWith(ITimePeriod period, ITimePeriod target) {
        ...
        if (isDebugEnabled)
            TimeTool.log.debug("period=[{}], target=[{}]이 overlap 되는지 확인합니다. isOverlaps=[{}]",
    ...
    public static TimeBlock getIntersectionBlock(ITimePeriod period, ITimePeriod target) {
        ...
        if (isDebugEnabled)
            TimeTool.log.debug("period=[{}], target=[{}]의 교집합 TimeBlock=[{}]을 구했습니다.",
    ...
    public static TimeBlock getUnionBlock(ITimePeriod period, ITimePeriod target) {
        ...
        if (isDebugEnabled)
            TimeTool.log.debug("period=[{}]와 target=[{}]의 합집합 TimeBlock=[{}]을 구했습니다.",
    ...
    public static TimeRange getIntersectionRange(ITimePeriod period, ITimePeriod target) {
        ...
        if (isDebugEnabled)
            TimeTool.log.debug("period=[{}]와 target=[{}]의 교집합 TimeRange=[{}]을 구했습니다.",
    ...
    public static TimeRange getUnionRange(ITimePeriod period, ITimePeriod target) {
        ...
        if (isDebugEnabled)
            TimeTool.log.debug("period=[{}]와 target=[{}]의 합집합 TimeRange=[{}]을 구했습니다.",
