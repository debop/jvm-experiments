...
import kr.ecsp.data.domain.model.StateEntity;
 ...
 */
@Slf4j
public class StateEntityInterceptor extends EmptyInterceptor {
	...
	public Boolean isPersisted(Object entity) {
		if (entity instanceof StateEntity)
			return ((StateEntity) entity).isPersisted();
		return null;
	}
