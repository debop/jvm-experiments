package kr.nsoft.data.hibernate.listener;
...
/**
 * {@link kr.nsoft.data.domain.model.IUpdateTimestampedEntity} 를 구현한 엔티티의 updateTimestamp 값을 엔티티 저장 시에 갱신해 주는 Event Listener 입니다.
