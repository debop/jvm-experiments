package kr.nsoft.data.hibernate.interceptor;
...
/**
 * {@link kr.nsoft.data.domain.model.IUpdateTimestampedEntity} 를 구현한 엔티티의 updateTimestamp 값을 엔티티 저장 시에 갱신해 주는 Interceptor 입니다.
