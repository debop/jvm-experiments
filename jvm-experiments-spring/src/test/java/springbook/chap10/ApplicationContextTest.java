...
public class ApplicationContextTest {
    ...
    public void setPropertyBean() {
        ...
        helloDef.getPropertyValues().addPropertyValue("name", "Springs");
        ...
        assertEquals("Hello Springs", hello2.sayHello());
    ...
    public void registerBeanWithDependency() {
        ...
        assertEquals("Hello Springs", context.getBean("printer").toString());
    }
...
//		context.refresh();
        ...
        assertEquals("Hello Canon", context.getBean("printer").toString());
    }
